        ...
        <div class="row">
          <div class="col-sm">
            <div style="padding:4px">
              <v-text-field color="blue" hide-details v-model="spName" label="SP Name"></v-text-field>
            </div>
            <div style="padding:4px">
              <v-text-field color="blue" hide-details v-model="spLib" label="Library"></v-text-field>
            </div>
            <div style="padding:4px">
              <v-text-field color="blue" hide-details v-model="specificName" label="Specific Name"></v-text-field>
            </div>
            <div style="padding:4px">
              <v-text-field color="blue" hide-details v-model="spParm" label="Parameter"></v-text-field>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm">
            <div style="padding:4px">
              <v-text-field color="blue" hide-details v-model="externalName" label="External Name"></v-text-field>
            </div>

            <div style="padding:4px">
              <v-text-field color="blue" hide-details v-model="externalLang" label="Language"></v-text-field>
            </div>
            <div style="padding:4px">
