<template>
  <div class style="min-width:900px">
    ...
    <v-card>
      <div style="white-space: pre-wrap; padding:10px;font-family: monospace" v-html="shellOutput"></div>
    </v-card>
    <v-card>
      <div id="sqleditor" style="min-height:700px"></div>
    </v-card>
  </div>
</template>
<script>
      ...
      this.runWebService(
        ...
        function(responce) {
          if (responce.data.status == "s") {
            ...
            vm.monacoEditor
              .getModel()
              .setValue(currentValue + responce.data.commandoutput);
